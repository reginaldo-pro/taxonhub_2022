...
const Ocurrencies = ({token}: TaxonomiesPageProps) => {
  ...
  let components = [
    ...
    {
      title: 'Step 2',
      component: <DoSearch token={token} model={"occurrency"} />,
      height: '150px',
    },
    {
      title: 'Step 3',
    ...
    {
      title: 'Step 4',
      component: <a href={"http://localhost:3333/occurrency/download?userId="+token}>
